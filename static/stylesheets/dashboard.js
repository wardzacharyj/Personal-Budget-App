...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    var uncategorized_progress_container = document.querySelector('.graph_holder');
    ...
    function initAllCategories(rawJson){
        ...
        allCats.forEach(function(item){
            if(temp == 0){
                ...
                temp = 1;
                var uncategorized = document.getElementById('card_frame');
                uncategorized.querySelector('.card-limit-label').textContent = item['cost'];
                uncategorized.querySelector('a').addEventListener('click', function(){
                    document.getElementById('cat_uncategorized').submit();
                });
            }
            else {
    ...
    /**
     *  Builds a new card by cloning default uncategorized purchases card and populating
